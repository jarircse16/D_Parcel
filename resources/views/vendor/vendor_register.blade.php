            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-3 text-center">Welcome to DmanBD</h4>

                        <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('vendor.register.create') }}">
                            @csrf

                            <div class="mb-3">
                                <!-- <label for="email" class="form-label">Email or Username</label> -->
                                <input  class="form-control" id="email" type="text" name="vendor_name"
							...
							<div class="mb-3">
                                <!-- <label for="email" class="form-label">Email or Username</label> -->
                                <input  class="form-control" id="email" type="number" name="mobile"
