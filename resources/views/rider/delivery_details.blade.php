            ...
            <div class="row">
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('rider.delivery.details.store', $delivery->id) }}"
                                ...
                                @if($delivery->pick_status == 'Delivered')
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control"
                                            id="basic-default-name" value="Delivered" />
                                        </div>
                                    </div>
                                </div>
                                @elseif($delivery->pick_status == 'Cancel')
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label" for="basic-default-email">Status :</label>
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input readonly type="text" class="form-control"
                                            id="basic-default-name" value="Cancel" />
                                        </div>
                                    </div>
                                </div>
                                @else
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <select name="pick_status" class="form-control">
